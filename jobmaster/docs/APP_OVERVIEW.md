...
- Main data file: `data/input/job-master.xlsx`
...
### **Troubleshooting**
- **Desktop App**: See `docs/DESKTOP_APP_TROUBLESHOOTING.md`
- **Bulk Job Checker**: See `docs/BULK_JOB_CHECKER_GUIDE.md`
- **General Issues**: See `docs/TROUBLESHOOTING.md`
